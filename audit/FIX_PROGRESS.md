...
| 15 | D-13 | 第二 | done-pending-commit | this commit | English/Chinese path grep matched implementation | 仅修正公开 CLI 文档的默认 Linux 路径大小写；XDG_DATA_HOME 语义和 Linux 代码/保证均不变 |
