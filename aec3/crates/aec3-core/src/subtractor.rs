...
mod tests {
    ...
    fn subtractor_creation() {
        ...
        let subtractor = Subtractor::new(aec3_simd::SimdBackend::Scalar, &config, 1, 1);
    ...
    fn subtractor_multichannel_creation() {
        let config = EchoCanceller3Config::default();
        let subtractor = Subtractor::new(aec3_simd::SimdBackend::Scalar, &config, 2, 4);
    ...
    fn handle_echo_path_change_delay() {
        let config = EchoCanceller3Config::default();
        let mut subtractor = Subtractor::new(aec3_simd::SimdBackend::Scalar, &config, 1, 1);
