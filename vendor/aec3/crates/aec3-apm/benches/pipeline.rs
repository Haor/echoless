//! Benchmarks for the AEC3 audio processing pipeline and components.
...
use aec3_apm::config::{EchoCanceller, GainController2, NoiseSuppression};
use aec3_apm::{AudioProcessing, Config, StreamConfig};
use aec3_common_audio::sinc_resampler::{SincResampler, SincResamplerCallback};
use aec3_fft::pffft::{FftType, Pffft};
use aec3_ns::config::{NS_FRAME_SIZE, SuppressionLevel};
