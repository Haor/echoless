//! Record microphone audio, process it through aec3-apm, and write WAV files.
//!
//! Writes both raw (unprocessed) and processed audio to separate files so you
//! can compare them.
//!
//! ```sh
//! cargo run -p aec3-apm --features examples --example recording -- --duration 5 --ns --agc
//! ```
...
#[derive(Parser, Debug)]
#[command(about = "Record and process microphone audio through aec3-apm")]
struct Args {
