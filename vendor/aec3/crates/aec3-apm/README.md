...
Provides a Rust API. A C API is available via the separate [`aec3-ffi`](https://crates.io/crates/aec3-ffi) crate.

## Usage

```rust
use aec3_apm::{AudioProcessing, Config, StreamConfig};
use aec3_apm::config::{EchoCanceller, NoiseSuppression, GainController2};
...
[crate-image]: https://img.shields.io/crates/v/aec3-apm.svg
[crate-link]: https://crates.io/crates/aec3-apm
[docs-image]: https://docs.rs/aec3-apm/badge.svg
[docs-link]: https://docs.rs/aec3-apm/
...
[build-image]: https://github.com/dignifiedquire/aec3-apm/actions/workflows/ci.yml/badge.svg?branch=main
[build-link]: https://github.com/dignifiedquire/aec3-apm/actions/workflows/ci.yml?query=branch:main

[//]: # (general links)

[WebRTC]: https://webrtc.org
[workspace README]: https://github.com/dignifiedquire/aec3-apm#readme
